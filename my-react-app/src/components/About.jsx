  ...
  return (
    <div className="about">
      ...
      <div className="about-dropdowns">
        ...
        <Collapse
          title="Sécurité"
          content="La sécurité est la priorité de Kasa. Aussi bien pour nos hôtes que pour les voyageurs, chaque logement correspond aux critères de sécurité établis par nos services. En laissant une note aussi bien à l'hôte qu'au locataire, cela permet à nos équipes de vérifier que les standards sont bien respectés. Nous organinons également des ateliers sur la sécurité domestique pour nos hôtes."
        />
      </div>
    </div>
  )
